...
return [
    ...
    'admin_user_email_on_tenant1' => env('ADMIN_USER_NAME_ON_TENANT1','Dídac Montero Borràs'),
    'admin_user_name_on_tenant1' => env('ADMIN_USER_EMAIL_ON_TENANT1','dmontero@iesebre.com'),
