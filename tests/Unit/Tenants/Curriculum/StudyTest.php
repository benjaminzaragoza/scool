...
class StudyTest extends TestCase
{
    ...
    public function mapForPublicView()
    {
        ...
        $mappedStudy = $study->mapForPublicView();
        ...
        $this->assertCount(1, $mappedStudy['subjectGroups'][0]['subjects']);
        $this->assertEquals('Disseny i implementació d’interfícies',$mappedStudy['subjectGroups'][0]['subjects'][0]['name']);
        $this->assertEquals('Interfícies',$mappedStudy['subjectGroups'][0]['subjects'][0]['shortname']);
        $this->assertEquals('DAM_MP7_UF1',$mappedStudy['subjectGroups'][0]['subjects'][0]['code']);
