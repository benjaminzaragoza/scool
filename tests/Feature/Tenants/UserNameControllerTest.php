...
/**
 * Class UsersNameControllerTest.
 *
 * @package Tests\Feature
 */
class UsersNameControllerTest extends BaseTenantTest
{
    use RefreshDatabase;
    ...
    public function can_get_user_by_name()
    {
        ...
        $response = $this->json('GET', '/api/v1/users/name/' . $user->name);
    ...
    public function regular_user_cannot_get_user_by_email()
    {
        ...
        $response = $this->json('GET', '/api/v1/users/name/' . $user->email);
    ...
    public function can_get_user_by_email_404()
    {
        ...
        $response = $this->json('GET', '/api/v1/users/name/noexistingename');
