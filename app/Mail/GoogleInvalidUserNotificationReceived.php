 ...
 * @package App\Mail
 */
class GoogleInvalidUserNotificationReceived extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->markdown('tenants.emails.google.invalid-notification')
            ->subject('INVALID Google User Notification Received')
            ->with([
                'type' => $type,
                'body' => $body,
